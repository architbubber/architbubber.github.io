...
// Portfolio — single-file React component (Tailwind CSS)
        ...
        <header className="flex items-center justify-between mb-12">
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <p className="text-sm text-slate-500">MS Computer Science • Full‑Stack Developer</p>
            </div>
          </div>
          ...
          <nav className="hidden md:flex gap-6 items-center text-sm">
            ...
            <a href="/resume.pdf" className="ml-4 inline-block px-3 py-2 rounded-md border border-slate-200 text-sm bg-white shadow-sm hover:shadow-lg">Resume</a>
          </nav>
        ...
        <section className="grid grid-cols-1 lg:grid-cols-3 gap-8 items-start mb-12">
          ...
          <aside className="bg-white rounded-2xl p-6 shadow-md flex flex-col gap-4">
            ...
            <div className="pt-3 border-t border-slate-100">
              ...
              <div className="text-xs text-slate-500">Aug 2025 — May 2027 (expected)</div>
            </div>
...
function ProjectCard({ title, tech, body, cta }) {
  return (
...
function ExperienceItem({ company, date, bullets = [] }) {
  return (
    <div className="mb-4">
